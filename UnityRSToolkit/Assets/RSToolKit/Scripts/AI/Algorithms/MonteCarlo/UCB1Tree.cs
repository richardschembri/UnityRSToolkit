...
using RSToolkit.Game.TurnBased;

namespace RSToolkit.AI.Algorithms.MonteCarlo
{
    /// <summary>
        ...
        where TGame : UCB1Tree<TGame, TMove, TPlayer>.IGame
    {
        ...
        public static Transition ParallelSearch(TGame game, long milliseconds)
        {
            ...
            Parallel.For(0L, Int64.MaxValue,
                ...
                () => new ThreadLocalVars(RandomHelpers.CreateForThread(), new List<Node>(50)),
                ...
                (i, loop, localVars) =>
                {
                    ...
                    while (!copy.IsGameOver())
                    {
                        ...
                        {
                            copy.Transition(transitionsNoStats.RandomListItem(localVars.random));
        ...
        public static Transition Search(TGame game, long milliseconds)
        {
            ...
            while (sw.ElapsedMilliseconds < milliseconds)
            {
                ...
                while (!copy.IsGameOver())
                {
                    ...
                    {
                        copy.Transition(transitionsNoStats.RandomListItem(rng));
