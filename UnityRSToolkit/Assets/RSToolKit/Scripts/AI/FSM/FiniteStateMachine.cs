// Taken from https://github.com/thefuntastic/Unity3d-Finite-State-Machine
using System;
...
{
    public enum FiniteStateTransition
    {
        Safe,
        Overwrite,
    }
    ...
    public class FiniteStateMachine<T> : IFiniteStateMachine where T : struct, IConvertible, IComparable
    {
        ...
        private FiniteStateMachineRunner engine;
        private MonoBehaviour component;

        private FiniteStateMapping lastState;
        private FiniteStateMapping currentState;
        private FiniteStateMapping destinationState;

        private Dictionary<object, FiniteStateMapping> stateLookup;
        ...
        {
            ChangeState(newState, FiniteStateTransition.Safe);
        }
        ...
        public FiniteStateMapping CurrentStateMap
        {
        ...
        public static FiniteStateMachine<T> Initialize(MonoBehaviour component)
        {
            var engine = component.GetComponent<FiniteStateMachineRunner>();
            if (engine == null) engine = component.gameObject.AddComponent<FiniteStateMachineRunner>();
