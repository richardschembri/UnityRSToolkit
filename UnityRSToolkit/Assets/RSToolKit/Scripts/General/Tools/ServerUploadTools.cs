...
{
    public static class ServerUploadTools
    {
        ...
        private static HttpWebResponse PostForm(string postUrl, string userAgent, string contentType, byte[] formData, string username = "", string password = "")
        {
            ...
            if (!String.IsNullOrEmpty(username) && !String.IsNullOrEmpty(password))
            {
                ...
                request.Headers.Add("Authorization", "Basic " + Convert.ToBase64String(System.Text.Encoding.Default.GetBytes(username + ":" + password)));//("username" + ":" + "password")));
            }
