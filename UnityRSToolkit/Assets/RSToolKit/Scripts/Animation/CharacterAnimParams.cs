...
namespace RSToolkit.Animation
{
    public static class CharacterAnimParams
    {
        ...
        public static readonly int HorizontalAxis = Animator.StringToHash("HorizontalAxis");
        public static readonly int VerticalAxis = Animator.StringToHash("VerticalAxis");
        ...
        public static void TrySetAxisHorizontal(Animator target, float value)
        {
            if(target != null){
                target?.SetFloat(HorizontalAxis, value);
            }
        }
        public static void TrySetAxisVertical(Animator target, float value)
        {
            if(target != null){
                target?.SetFloat(VerticalAxis, value);
            }
        }
